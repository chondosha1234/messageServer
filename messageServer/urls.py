...
urlpatterns = [
    ...
    path('groups/set_picture', views.set_group_picture, name='set_group_picture'),
    ...
    path('groups/conversation/set_picture', views.set_conversation_picture, name='set_conversation_picture'),
    ...
    path('users/search/<str:query>', views.search_users, name='search_users'),
