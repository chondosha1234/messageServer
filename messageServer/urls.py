...
urlpatterns = [
    ...
    path('path/<int:group_id>/<int:user_id>/add_member', views.add_member, name='add_member'),
    path('path/<int:group_id>/<int:user_id>/remove_member', views.remove_member, name='remove_member'),
